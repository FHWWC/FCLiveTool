...
public partial class VideoSubPageAndroid : ContentPage
{
    public VideoSubPageAndroid()
    {
        InitializeComponent();
    }

    public static VideoSubPageAndroid videoSubPageAndroid;
    ...
    {
        if (videoSubPageAndroid != null)
        {
            return;
        }

        videoSubPageAndroid=this;
